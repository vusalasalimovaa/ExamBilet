...
const Admin = () => {
  const { data: admin, refetch } = useGetAllMenuQuery();
  ...
  if (sortType === "a-z") {
    filteredAdmin.sort((a, b) => a.title.localeCompare(b.title));
  } else if (sortType === "z-a") {
    filteredAdmin.sort((a, b) => b.title.localeCompare(a.title));
  } else if (sortType === "low-high") {
    filteredAdmin.sort((a, b) => a.price - b.price);
  } else if (sortType === "high-low") {
    filteredAdmin.sort((a, b) => b.price - a.price);
  }
  return (
    <>
      <>
